...
if [ "$#" == 0 ];then
	...
	echo Usage : ./Uninstall_Full.sh [wiperdog_home_path]
	exit
...
# Check MongoDB data
echo " Please check mongodb data manually ! , if data removed ,this case is PASSED , otherwise this is FAILED" 
